...
class ObstacleAvoidanceNavigation(Node):
    def __init__(self):
        ...
        self.declare_parameter('goal_tolerance', 0.1)  # Distance tolerance to goal
       
        # Detection parameters 
        self.declare_parameter('detection_distance', 3.0)  
        self.declare_parameter('detection_angle', 140.0)    # Wider detection angle
        self.declare_parameter('min_height', 0.5)           # To walk over little-height obstacles
    ...
    def lidar_callback(self, msg):
        ...
        try:
            for point in pc2.read_points(msg, field_names=('x', 'y', 'z'), skip_nans=True):
                ...
                # Filter by height - keep ground/low level obstacles
