...
from launch.event_handlers import OnTopicAvailable
...
def generate_launch_description():
    ...
    declare_robot_name = DeclareLaunchArgument("robot_name", default_value="go2", description="Robot name")
    ...
    declare_gui = DeclareLaunchArgument("gui", default_value="true", description="Gazebo GUI")
    ...
    # Bringup (includes robot description and control setup)
    ...
    # Spawn robot only after /robot_description is available
